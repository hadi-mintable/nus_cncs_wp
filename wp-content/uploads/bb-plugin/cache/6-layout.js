...
if(jQuery('body').hasClass('fl-builder-edit')&&this.small_device<30){jQuery('body').find(node).addClass('uabb-mobile-spacer-height-adjustment');}},};})(jQuery);jQuery(document).ready(function(){new UABBSpacerGap({id:'5f2ba95c6d15b',desktop_space:'20',medium_device:'',small_device:'0',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5f584af8071ab',desktop_space:'20',medium_device:'',small_device:'0',});});