...
else{opacity.hide();}},};})(jQuery);(function($){$(function(){new FLBuilderMenu({id:'5f2bcf4d2ca4e',type:'expanded',mobile:'expanded',mobileBelowRow:false,mobileFlyout:false,breakPoints:{medium:991,small:767},mobileBreakpoint:'mobile'});});})(jQuery);jQuery(function($){$(function(){$('.fl-node-5f324cc4c638d .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});